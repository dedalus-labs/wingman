...
import { Config, GeminiClient, ToolRegistry } from '@dedalus-labs/wingman-core';
import { GenerateContentResponse, Part, FunctionCall } from '@google/genai';

// Mock dependencies
vi.mock('@dedalus-labs/wingman-core', async () => {
  const actualCore = await vi.importActual<
    typeof import('@dedalus-labs/wingman-core')
  >('@dedalus-labs/wingman-core');
  return {
    ...actualCore,
    GeminiClient: vi.fn(),
    ToolRegistry: vi.fn(),
