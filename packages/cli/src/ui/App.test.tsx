...
// Mock @dedalus-labs/wingman-core and its Config class
vi.mock('@dedalus-labs/wingman-core', async (importOriginal) => {
  const actualCore =
    await importOriginal<typeof import('@dedalus-labs/wingman-core')>();
