...
import { Config } from '@dedalus-labs/wingman-core';
  ...
  return (
    <Box flexDirection="column" marginY={1}>
      <Text bold color={Colors.AccentPurple}>
        Dedalus Code Assist for Individuals Privacy Notice
      </Text>
      <Newline />
      <Text>
        This notice and our Privacy Policy
        <Text color={Colors.AccentBlue}>[1]</Text> describe how Dedalus Code
        Assist handles your data. Please read them carefully.
      </Text>
      <Newline />
      <Text>
        When you use Dedalus Code Assist for individuals with Dedalus Wingman CLI, Dedalus
        ...
        improve, and develop Dedalus products and services and machine learning
        technologies.
      </Text>
      <Newline />
      <Text>
