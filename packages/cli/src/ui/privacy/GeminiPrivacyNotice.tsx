  ...
  return (
    <Box flexDirection="column" marginBottom={1}>
      <Text bold color={Colors.AccentPurple}>
        Dedalus API Key Notice
      </Text>
      <Newline />
      <Text>
        By using the Dedalus API<Text color={Colors.AccentBlue}>[1]</Text>,
        Dedalus AI Studio
        <Text color={Colors.AccentRed}>[2]</Text>, and the other Dedalus
        developer services that reference these terms (collectively, the
        &quot;APIs&quot; or &quot;Services&quot;), you are agreeing to Dedalus
        APIs Terms of Service (the &quot;API Terms&quot;)
        <Text color={Colors.AccentGreen}>[3]</Text>, and the Dedalus API
      ...
      <Text>
        ...
        https://api.dedalus.ai/docs/overview
      </Text>
      <Text>
        <Text color={Colors.AccentRed}>[2]</Text> https://studio.dedalus.ai/
      </Text>
      <Text>
        <Text color={Colors.AccentGreen}>[3]</Text>{' '}
        https://developers.dedalus.ai/terms
      </Text>
      <Text>
        <Text color={Colors.AccentPurple}>[4]</Text>{' '}
        https://api.dedalus.ai/terms
      </Text>
      <Newline />
