...
/**
 * A tool to perform web searches using Google Search via the Dedalus API.
 */
export class WebSearchTool extends BaseTool<
  WebSearchToolParams,
  WebSearchToolResult
> {
  static readonly Name: string = 'dedalus_web_search';

  constructor(private readonly config: Config) {
    super(
      WebSearchTool.Name,
      'DedalusWebSearch',
      'Performs a web search using Google Search (via the Dedalus API) and returns the results. This tool is useful for finding information on the internet based on a query.',
      {
        type: Type.OBJECT,
        properties: {
          query: {
